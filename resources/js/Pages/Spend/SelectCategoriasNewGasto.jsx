...
const SelectCategoriasNewGasto = (params) => {
    ...
    function cargarDatos(){
          let opts=[]
            for (let i=0; i<params.categorias.length; i++){
                let item= new OptionsAuto(params.categorias[i].codigo, params.categorias[i].nombreCate)
                opts.push(item)
            }
            setOptions(opts)
    }
    ...
    function getChange(e){
       const input=document.getElementById('inputValueNewCateGasto')
