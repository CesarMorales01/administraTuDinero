    ...
    return (
        <div style={{ marginTop: '0.5em' }} className='table-responsive'>
            <table className="table table-striped  roundedTable">
                <thead style={{backgroundColor: "#dd5035"}} className='align-middle'>
                    <tr>
                            ...
                            return (
                                <tr key={index}>
                                    ...
                                    <th style={{ textAlign: 'center' }}>
                                        <button onClick={() => params.confirmarBorrar(item)} className='border border-dark rounded cursorPointer' style={{ padding: '0.2em', backgroundColor: 'red', display: item.precio === 0 ? 'none' : 'inline' }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" wcodigoth="16" height="16" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
